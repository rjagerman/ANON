...
\section{Introduction to Tor}
	...
	\subsection{Disadvantages}
		...
		\subsection{Tor stinks}
			The anonymous communication with Tor can also be used for distribution illegal content or setting up illegal services. Illegal content and services are a serious problem that Tor is facing. A recent example is the shutdown of \emph{Silk Road}, an online market for trading drugs. This market operated as a hidden Tor service. These hidden services are accessed through their onion address and not through their IP-address, hiding the physical location of the service. This makes it very hard for agencies to track and shut down these operations.
