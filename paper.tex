...
\section{The difficulties of decentralizing Tor}
...
\section{Conclusion}
We come to the conclusion that there is no complete decentralized system that provides the full functionality and security that Tor offers today. While there is a lot of research on decentralized systems, only a few are actually implemented. The systems that do exist such as X and Y (hier deze noemen aan de hand van de tabel) are getting things right, yet they often lack or have poor implementations on other aspects.\\
